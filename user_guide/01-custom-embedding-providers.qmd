...
If you want your provider to work with `ChromaDBStore`, implement the `to_chroma()` method:
...
This method is called automatically when using your provider with `ChromaDBStore`. If not implemented, ChromaDB will use your provider's `embed()` method directly via an adapter.
