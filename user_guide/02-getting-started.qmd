...
- **Use a different chunker** — Any chunker that returns a chunked document will work. See the [Chunking](chunking.qmd) guide for more options, including [chonkie](https://github.com/chonkie-inc/chonkie) integration.
