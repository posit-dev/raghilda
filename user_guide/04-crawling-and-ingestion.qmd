...
raghilda can crawl files or websites, convert each source to Markdown, chunk the
documents, and write them to a store as a streaming ingestion job. This is the
main path for building or refreshing a knowledge base from source material that
changes over time.
